...
Public Class frmYear
	...
	Private Function CalculateAverage() As String
		...
		Dim labels() = {lblJanDuration, lblFebDuration, lblMarDuration, lblAprDuration, lblMayDuration, lblJunDuration, lblJulDuration, lblAugDuration, lblSepDuration, lblOctDuration, lblNovDuration, lblDecDuration} 'an array of 1 thru 12
		...
		Return $"{Math.Floor(avgMins)}:{Math.Floor(remainderSec)}"
	End Function
	...
	Private Sub ColorYearMetrics()
		'Display the appropriate color for BTE, Expected, Inconsistent, or Unacceptable for the employees metrics.
		Dim yearCSAT As Double
		Dim yearAway As Double

		Double.TryParse(lblYearCSAT.Text, yearCSAT)
		Double.TryParse(lblYearAway.Text, yearAway)
		...
		If yearCSAT = 100 Then
			lblYearCSAT.BackColor = Color.SteelBlue
			lblYearCSAT.ForeColor = Color.White
		End If

		If yearAway = 100 Then
			lblYearAway.BackColor = Color.IndianRed
			lblYearAway.ForeColor = Color.Black
		End If
	...
	Private Sub btnCalculate_Click(sender As Object, e As EventArgs) Handles btnCalculate.Click
		'Declare variables for the metrics and yearly average. Variables with integers coincide with the statements below depending on how many months have data.

		'Duration variables
		Dim strYearDuration As String
		...
		'Away variables
		Dim dblAway1 As Double
		Dim dblAway2 As Double
		Dim dblAway3 As Double
		Dim dblAway4 As Double
		Dim dblAway5 As Double
		Dim dblAway6 As Double
		Dim dblAway7 As Double
		Dim dblAway8 As Double
		Dim dblAway9 As Double
		Dim dblAway10 As Double
		Dim dblAway11 As Double
		Dim dblAway12 As Double
		Dim dblJanAway As Double
		Dim dblFebAway As Double
		Dim dblMarAway As Double
		Dim dblAprAway As Double
		Dim dblMayAway As Double
		Dim dblJunAway As Double
		Dim dblJulAway As Double
		Dim dblAugAway As Double
		Dim dblSepAway As Double
		Dim dblOctAway As Double
		Dim dblNovAway As Double
		Dim dblDecAway As Double

		'Quality variables
		Dim dblQual1 As Double
		Dim dblQual2 As Double
		Dim dblQual3 As Double
		Dim dblQual4 As Double
		Dim dblQual5 As Double
		Dim dblQual6 As Double
		Dim dblQual7 As Double
		Dim dblQual8 As Double
		Dim dblQual9 As Double
		Dim dblQual10 As Double
		Dim dblQual11 As Double
		Dim dblQual12 As Double
		Dim dblJanQual As Double
		Dim dblFebQual As Double
		Dim dblMarQual As Double
		Dim dblAprQual As Double
		Dim dblMayQual As Double
		Dim dblJunQual As Double
		Dim dblJulQual As Double
		Dim dblAugQual As Double
		Dim dblSepQual As Double
		Dim dblOctQual As Double
		Dim dblNovQual As Double
		Dim dblDecQual As Double

		'Development variables
		Dim dblDev As Double
		Dim dblJanDev As Double
		Dim dblFebDev As Double
		Dim dblMarDev As Double
		Dim dblAprDev As Double
		Dim dblMayDev As Double
		Dim dblJunDev As Double
		Dim dblJulDev As Double
		Dim dblAugDev As Double
		Dim dblSepDev As Double
		Dim dblOctDev As Double
		Dim dblNovDev As Double
		Dim dblDecDev As Double

		'Use tryparse for the CSAT monthly labels.
		...
		'Use tryparse for the Away monthly labels.
		Double.TryParse(lblJanAway.Text, dblJanAway)
		Double.TryParse(lblFebAway.Text, dblFebAway)
		Double.TryParse(lblMarAway.Text, dblMarAway)
		Double.TryParse(lblAprAway.Text, dblAprAway)
		Double.TryParse(lblMayAway.Text, dblMayAway)
		Double.TryParse(lblJunAway.Text, dblJunAway)
		Double.TryParse(lblJulAway.Text, dblJulAway)
		Double.TryParse(lblAugAway.Text, dblAugAway)
		Double.TryParse(lblSepAway.Text, dblSepAway)
		Double.TryParse(lblOctAway.Text, dblOctAway)
		Double.TryParse(lblNovAway.Text, dblNovAway)
		Double.TryParse(lblDecAway.Text, dblDecAway)

		'Use tryparse for the Quality monthly labels.
		Double.TryParse(lblJanQual.Text, dblJanQual)
		Double.TryParse(lblFebQual.Text, dblFebQual)
		Double.TryParse(lblMarQual.Text, dblMarQual)
		Double.TryParse(lblAprQual.Text, dblAprQual)
		Double.TryParse(lblMayQual.Text, dblMayQual)
		Double.TryParse(lblJunQual.Text, dblJunQual)
		Double.TryParse(lblJulQual.Text, dblJulQual)
		Double.TryParse(lblAugQual.Text, dblAugQual)
		Double.TryParse(lblSepQual.Text, dblSepQual)
		Double.TryParse(lblOctQual.Text, dblOctQual)
		Double.TryParse(lblNovQual.Text, dblNovQual)
		Double.TryParse(lblDecQual.Text, dblDecQual)

		'Use tryparse for the Development monthly labels.
		Double.TryParse(lblJanDev.Text, dblJanDev)
		Double.TryParse(lblFebDev.Text, dblFebDev)
		Double.TryParse(lblMarDev.Text, dblMarDev)
		Double.TryParse(lblAprDev.Text, dblAprDev)
		Double.TryParse(lblMayDev.Text, dblMayDev)
		Double.TryParse(lblJunDev.Text, dblJunDev)
		Double.TryParse(lblJulDev.Text, dblJulDev)
		Double.TryParse(lblAugDev.Text, dblAugDev)
		Double.TryParse(lblSepDev.Text, dblSepDev)
		Double.TryParse(lblOctDev.Text, dblOctDev)
		Double.TryParse(lblNovDev.Text, dblNovDev)
		Double.TryParse(lblDecDev.Text, dblDecDev)

		strYearDuration = CalculateAverage()
		lblYearDuration.Text = strYearDuration

		'Calculate the average for CSAT if all months have metric data, if not get the average for how many months do have metric data.
		...
		'Calculate the average for Away if all months have metric data, if not get the average for how many months do have metric data.
		If lblJanAway.Text IsNot "" Then
			dblAway1 = dblJanAway
			lblYearAway.Text = dblAway1.ToString("n2")
		End If

		If lblJanAway.Text IsNot "" And lblFebAway.Text IsNot "" Then
			dblAway2 = (dblJanAway + dblFebAway) / 2
			lblYearAway.Text = dblAway2.ToString("n2")
		End If

		If lblJanAway.Text IsNot "" And lblFebAway.Text IsNot "" And lblMarAway.Text IsNot "" Then
			dblAway3 = (dblJanAway + dblFebAway + dblMarAway) / 3
			lblYearAway.Text = dblAway3.ToString("n2")
		End If

		If lblJanAway.Text IsNot "" And lblFebAway.Text IsNot "" And lblMarAway.Text IsNot "" And lblAprAway.Text IsNot "" Then
			dblAway4 = (dblJanAway + dblFebAway + dblMarAway + dblAprAway) / 4
			lblYearAway.Text = dblAway4.ToString("n2")
		End If

		If lblJanAway.Text IsNot "" And lblFebAway.Text IsNot "" And lblMarAway.Text IsNot "" And lblAprAway.Text IsNot "" And lblMayAway.Text IsNot "" Then
			dblAway5 = (dblJanAway + dblFebAway + dblMarAway + dblAprAway + dblMayAway) / 5
			lblYearAway.Text = dblAway5.ToString("n2")
		End If
		...
		If lblJanAway.Text IsNot "" And lblFebAway.Text IsNot "" And lblMarAway.Text IsNot "" And lblAprAway.Text IsNot "" And lblMayAway.Text IsNot "" And lblJunAway.Text IsNot "" Then
			dblAway6 = (dblJanAway + dblFebAway + dblMarAway + dblAprAway + dblMayAway + dblJunAway) / 6
			lblYearAway.Text = dblAway6.ToString("n2")
		End If

		If lblJanAway.Text IsNot "" And lblFebAway.Text IsNot "" And lblMarAway.Text IsNot "" And lblAprAway.Text IsNot "" And lblMayAway.Text IsNot "" And lblJunAway.Text IsNot "" And lblJulAway.Text IsNot "" Then
			dblAway7 = (dblJanAway + dblFebAway + dblMarAway + dblAprAway + dblMayAway + dblJunAway + dblJulAway) / 7
			lblYearAway.Text = dblAway7.ToString("n2")
		End If

		If lblJanAway.Text IsNot "" And lblFebAway.Text IsNot "" And lblMarAway.Text IsNot "" And lblAprAway.Text IsNot "" And lblMayAway.Text IsNot "" And lblJunAway.Text IsNot "" And lblJulAway.Text IsNot "" And lblAugAway.Text IsNot "" Then
			dblAway8 = (dblJanAway + dblFebAway + dblMarAway + dblAprAway + dblMayAway + dblJunAway + dblJulAway + dblAugAway) / 8
			lblYearAway.Text = dblAway8.ToString("n2")
		End If

		If lblJanAway.Text IsNot "" And lblFebAway.Text IsNot "" And lblMarAway.Text IsNot "" And lblAprAway.Text IsNot "" And lblMayAway.Text IsNot "" And lblJunAway.Text IsNot "" And lblJulAway.Text IsNot "" And lblAugAway.Text IsNot "" And lblSepAway.Text IsNot "" Then
			dblAway9 = (dblJanAway + dblFebAway + dblMarAway + dblAprAway + dblMayAway + dblJunAway + dblJulAway + dblAugAway + dblSepAway) / 9
			lblYearAway.Text = dblAway9.ToString("n2")
		End If

		If lblJanAway.Text IsNot "" And lblFebAway.Text IsNot "" And lblMarAway.Text IsNot "" And lblAprAway.Text IsNot "" And lblMayAway.Text IsNot "" And lblJunAway.Text IsNot "" And lblJulAway.Text IsNot "" And lblAugAway.Text IsNot "" And lblSepAway.Text IsNot "" And lblOctAway.Text IsNot "" Then
			dblAway10 = (dblJanAway + dblFebAway + dblMarAway + dblAprAway + dblMayAway + dblJunAway + dblJulAway + dblAugAway + dblSepAway + dblOctAway) / 10
			lblYearAway.Text = dblAway10.ToString("n2")
		End If

		If lblJanAway.Text IsNot "" And lblFebAway.Text IsNot "" And lblMarAway.Text IsNot "" And lblAprAway.Text IsNot "" And lblMayAway.Text IsNot "" And lblJunAway.Text IsNot "" And lblJulAway.Text IsNot "" And lblAugAway.Text IsNot "" And lblSepAway.Text IsNot "" And lblOctAway.Text IsNot "" And lblNovAway.Text IsNot "" Then
			dblAway11 = (dblJanAway + dblFebAway + dblMarAway + dblAprAway + dblMayAway + dblJunAway + dblJulAway + dblAugAway + dblSepAway + dblOctAway + dblNovAway) / 11
			lblYearAway.Text = dblAway11.ToString("n2")
		End If

		If lblJanAway.Text IsNot "" And lblFebAway.Text IsNot "" And lblMarAway.Text IsNot "" And lblAprAway.Text IsNot "" And lblMayAway.Text IsNot "" And lblJunAway.Text IsNot "" And lblJulAway.Text IsNot "" And lblAugAway.Text IsNot "" And lblSepAway.Text IsNot "" And lblOctAway.Text IsNot "" And lblNovAway.Text IsNot "" And lblDecAway.Text IsNot "" Then
			dblAway12 = (dblJanAway + dblFebAway + dblMarAway + dblAprAway + dblMayAway + dblJunAway + dblJulAway + dblAugAway + dblSepAway + dblOctAway + dblNovAway + dblDecAway) / 12
			lblYearAway.Text = dblAway12.ToString("n2")
		End If

		'Calculate the average for Quality if all months have metric data, if not get the average for how many months do have metric data.
		If lblJanQual.Text IsNot "" Then
			dblQual1 = dblJanQual
			lblYearQual.Text = dblQual1.ToString("n2")
		End If

		If lblJanQual.Text IsNot "" And lblFebQual.Text IsNot "" Then
			dblQual2 = (dblJanQual + dblFebQual) / 2
			lblYearQual.Text = dblQual2.ToString("n2")
		End If

		If lblJanQual.Text IsNot "" And lblFebQual.Text IsNot "" And lblMarQual.Text IsNot "" Then
			dblQual3 = (dblJanQual + dblFebQual + dblMarQual) / 3
			lblYearQual.Text = dblQual3.ToString("n2")
		End If

		If lblJanQual.Text IsNot "" And lblFebQual.Text IsNot "" And lblMarQual.Text IsNot "" And lblAprQual.Text IsNot "" Then
			dblQual4 = (dblJanQual + dblFebQual + dblMarQual + dblAprQual) / 4
			lblYearQual.Text = dblQual4.ToString("n2")
		End If

		If lblJanQual.Text IsNot "" And lblFebQual.Text IsNot "" And lblMarQual.Text IsNot "" And lblAprQual.Text IsNot "" And lblMayQual.Text IsNot "" Then
			dblQual5 = (dblJanQual + dblFebQual + dblMarQual + dblAprQual + dblMayQual) / 5
			lblYearQual.Text = dblQual5.ToString("n2")

		End If

		If lblJanQual.Text IsNot "" And lblFebQual.Text IsNot "" And lblMarQual.Text IsNot "" And lblAprQual.Text IsNot "" And lblMayQual.Text IsNot "" And lblJunQual.Text IsNot "" Then
			dblQual6 = (dblJanQual + dblFebQual + dblMarQual + dblAprQual + dblMayQual + dblJunQual) / 6
			lblYearQual.Text = dblQual6.ToString("n2")
		End If

		If lblJanQual.Text IsNot "" And lblFebQual.Text IsNot "" And lblMarQual.Text IsNot "" And lblAprQual.Text IsNot "" And lblMayQual.Text IsNot "" And lblJunQual.Text IsNot "" And lblJulQual.Text IsNot "" Then
			dblQual7 = (dblJanQual + dblFebQual + dblMarQual + dblAprQual + dblMayQual + dblJunQual + dblJulQual) / 7
			lblYearQual.Text = dblQual7.ToString("n2")
		End If

		If lblJanQual.Text IsNot "" And lblFebQual.Text IsNot "" And lblMarQual.Text IsNot "" And lblAprQual.Text IsNot "" And lblMayQual.Text IsNot "" And lblJunQual.Text IsNot "" And lblJulQual.Text IsNot "" And lblAugQual.Text IsNot "" Then
			dblQual8 = (dblJanQual + dblFebQual + dblMarQual + dblAprQual + dblMayQual + dblJunQual + dblJulQual + dblAugQual) / 8
			lblYearQual.Text = dblQual8.ToString("n2")
		End If

		If lblJanQual.Text IsNot "" And lblFebQual.Text IsNot "" And lblMarQual.Text IsNot "" And lblAprQual.Text IsNot "" And lblMayQual.Text IsNot "" And lblJunQual.Text IsNot "" And lblJulQual.Text IsNot "" And lblAugQual.Text IsNot "" And lblSepQual.Text IsNot "" Then
			dblQual9 = (dblJanQual + dblFebQual + dblMarQual + dblAprQual + dblMayQual + dblJunQual + dblJulQual + dblAugQual + dblSepQual) / 9
			lblYearQual.Text = dblQual9.ToString("n2")
		End If

		If lblJanQual.Text IsNot "" And lblFebQual.Text IsNot "" And lblMarQual.Text IsNot "" And lblAprQual.Text IsNot "" And lblMayQual.Text IsNot "" And lblJunQual.Text IsNot "" And lblJulQual.Text IsNot "" And lblAugQual.Text IsNot "" And lblSepQual.Text IsNot "" And lblOctQual.Text IsNot "" Then
			dblQual10 = (dblJanQual + dblFebQual + dblMarQual + dblAprQual + dblMayQual + dblJunQual + dblJulQual + dblAugQual + dblSepQual + dblOctQual) / 10
			lblYearQual.Text = dblQual10.ToString("n2")
		End If

		If lblJanQual.Text IsNot "" And lblFebQual.Text IsNot "" And lblMarQual.Text IsNot "" And lblAprQual.Text IsNot "" And lblMayQual.Text IsNot "" And lblJunQual.Text IsNot "" And lblJulQual.Text IsNot "" And lblAugQual.Text IsNot "" And lblSepQual.Text IsNot "" And lblOctQual.Text IsNot "" And lblNovQual.Text IsNot "" Then
			dblQual11 = (dblJanQual + dblFebQual + dblMarQual + dblAprQual + dblMayQual + dblJunQual + dblJulQual + dblAugQual + dblSepQual + dblOctQual + dblNovQual) / 11
			lblYearQual.Text = dblQual11.ToString("n2")
		End If

		If lblJanQual.Text IsNot "" And lblFebQual.Text IsNot "" And lblMarQual.Text IsNot "" And lblAprQual.Text IsNot "" And lblMayQual.Text IsNot "" And lblJunQual.Text IsNot "" And lblJulQual.Text IsNot "" And lblAugQual.Text IsNot "" And lblSepQual.Text IsNot "" And lblOctQual.Text IsNot "" And lblNovQual.Text IsNot "" And lblDecQual.Text IsNot "" Then
			dblQual12 = (dblJanQual + dblFebQual + dblMarQual + dblAprQual + dblMayQual + dblJunQual + dblJulQual + dblAugQual + dblSepQual + dblOctQual + dblNovQual + dblDecQual) / 12
			lblYearQual.Text = dblQual12.ToString("n2")
		End If

		'Calculate how many development hours an employee has so far for the year.
		dblDev = dblJanDev + dblFebDev + dblMarDev + dblAprDev + dblMayDev + dblJunDev + dblJulDev + dblAugDev + dblSepDev + dblOctDev + dblNovDev + dblDecDev
		lblYearDev.Text = dblDev.ToString("n2")
